    ...
    public async Task EveryGeneratedModuleIsAcceptedByTheInteractionService()
    {
        ...
        CollectionAssert.AreEqual(
            new[]
            {
                ...
                "bank:v1:modal:panel-account-review:*",
                "bank:v1:modal:panel-atm-cassette:*",
                "bank:v1:modal:panel-atm-network:*",
                "bank:v1:modal:panel-atm-service:*",
                "bank:v1:modal:panel-atm-terminal:*",
                "bank:v1:modal:panel-bank-design:*",
                "bank:v1:modal:panel-calendar-clear:*",
                "bank:v1:modal:panel-calendar-set:*",
                "bank:v1:modal:panel-cash-conversion:*",
                "bank:v1:modal:panel-denomination:*",
                "bank:v1:modal:panel-fee-schedule:*",
                "bank:v1:modal:panel-insurance-fund:*",
                "bank:v1:modal:panel-insurance-scheme:*",
                "bank:v1:modal:panel-insurance-state:*",
                "bank:v1:modal:panel-intervention:*",
                "bank:v1:modal:panel-merchant-price:*",
                "bank:v1:modal:panel-merchant-product:*",
                "bank:v1:modal:panel-merchant-stock:*",
                "bank:v1:modal:panel-network-policy:*",
                "bank:v1:modal:panel-network-state:*",
                "bank:v1:modal:panel-operator-grant:*",
                "bank:v1:modal:panel-presentation:*",
                "bank:v1:modal:panel-prudential-policy:*",
                "bank:v1:modal:panel-resolution:*",
