...
public static class DiscordServiceRegistration
{
    public static IServiceCollection AddNumeraDiscord(this IServiceCollection services)
    {
        ...
        services.AddSingleton<
            Numera.Application.Abstractions.IAtmInstallationMessageGateway,
            AtmInstallationMessageGateway>();
        ...
        services.AddSingleton<Endpoints.ManageFxEndpoints>();
        ...
        services.AddSingleton<Rendering.IFxChartRenderer, Rendering.FxChartRenderer>();
        services.AddSingleton<Application.Abstractions.IFxChartImageRenderer, Rendering.SkiaFxChartImageRenderer>();
