...
public static partial class InvariantViolationCode
{
    ...
    public const string AccountProductTransitionInvalid = "ACCOUNT_PRODUCT_TRANSITION_INVALID";
    public const string AccountProductStatusUnknown = "ACCOUNT_PRODUCT_STATUS_UNKNOWN";
}
